...
import { BotIcon, GithubIcon, OctagonAlert, OctagonAlertIcon } from "lucide-react";
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <Button variant={"outline"} type="button" className="w-full"><BotIcon/>Google</Button>
                            ...
                            <div className="text-center text-sm">
                                Don&apos;t have an account? <Link className="underline underline-offset-4" href={"/sign-up"}>SignUp</Link>
                                </div>
